          ...
          <div id="overview" class="section mb-8 sm:mb-12">
            ...
            >
              ...
              >
                ...
                <h3
                  class="text-xs sm:text-xs font-semibold text-primary-green mb-1 mt-4 sm:mt-5 break-words"
                >
                  ...
                  <div class="flex items-center min-w-0 flex-1">
                    ...
                    <div class="text-left min-w-0">
                      <NuxtLink
                        ...
                        class="font-semibold text-primary-green block text-sm sm:text-base truncate hover:underline"
                      >
                        {{ school.name }}
                      </NuxtLink>
