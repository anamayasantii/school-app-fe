...
const showRatingFilter = ref(true)
const showUserFilter = ref(true)
...
const ratingDistribution = [
  ...
  { stars: 4, count: 45, percentage: 45 },
  { stars: 3, count: 20, percentage: 20 },
  { stars: 2, count: 8, percentage: 8 },
...
<template>
  <div class="max-w-7xl mx-auto px-4 py-8">
    ...
    <div class="bg-white rounded-xl p-6 mb-6 shadow-sm">
      ...
      <!-- Bottom: Bar Chart + Category Ratings (6 columns) -->
      <div class="grid grid-cols-6 gap-6">
        <!-- Column 1: Rating Distribution Bars -->
            ...
            <div v-show="showRatingFilter" class="mt-3 space-y-3">
              ...
              >
                <input
                  ...
                  class="w-5 h-5 text-gray-900 border-gray-300 focus:ring-gray-900"
                />
            ...
            <div v-show="showUserFilter" class="mt-3 space-y-3">
              <label class="flex items-center gap-3 cursor-pointer group">
                <input
                  ...
                  class="w-5 h-5 text-gray-900 border-gray-300 focus:ring-gray-900"
                />
                <span class="text-sm text-gray-700 group-hover:text-gray-900">Student</span>
              </label>
              ...
              <label class="flex items-center gap-3 cursor-pointer group">
                <input
                  ...
                  class="w-5 h-5 text-gray-900 border-gray-300 focus:ring-gray-900"
                />
                <span class="text-sm text-gray-700 group-hover:text-gray-900">Alumni</span>
              </label>
              ...
              <label class="flex items-center gap-3 cursor-pointer group">
                <input
                  ...
                  class="w-5 h-5 text-gray-900 border-gray-300 focus:ring-gray-900"
                />
                <span class="text-sm text-gray-700 group-hover:text-gray-900">Parent</span>
              </label>
            </div>
          </div>
        </div>
