    ...
    <section class="max-w-7xl mx-auto px-6 py-16 sm:px-6 lg:px-8">
      ...
      <div class="text-center mb-12">
        ...
        <p class="text-gray-600 max-w-3xl mx-auto">
          Menghapus pemisahan data dan penginputan ganda secara permanen dengan cara menghubungkan sistem SDM (sumber daya manusia), pencatatan waktu kerja, manajemen proyek, dan akuntansi dalam satu sistem terpadu.
        </p>
      </div>
              ...
              <div class="flex-1">
                ...
                <div class="flex items-center gap-3 text-sm">
                  <span
                    ...
                    :class="review.userStatus === 'Alumni' ? 'bg-amber-100 text-amber-700' : 'bg-teal-100 text-teal-700'"
                  >
                    {{ review.userStatus }}
                  </span>
