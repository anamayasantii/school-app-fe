<template>
  <div class="max-w-5xl mx-auto p-6">
    <div class="mb-6">
      ...
      <p class="text-gray-600">Update data sekolah</p>
    </div>
      ...
      <div class="flex items-start gap-3">
        <div class="flex-1">
          <h3
            class="font-semibold"
            :class="
              toastVariant === 'destructive' ? 'text-red-600' : 'text-green-600'
            "
          >
            {{ toastTitle }}
          </h3>
    ...
    <form v-else @submit.prevent="handleSubmit" class="space-y-8">
      ...
      <div class="bg-white p-6 rounded-lg border">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            ...
            <Input
              id="ownershipStatus"
              v-model="formData.ownershipStatus"
              placeholder="Contoh: Negeri, Swasta"
              required
            />
          </div>
      ...
      <div class="bg-white p-6 rounded-lg border">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <Input
              id="dateEstablishmentDecree"
              type="date"
              v-model="formData.dateEstablishmentDecree"
            />
          </div>
          ...
          <div>
            ...
            <Input
              id="operationalLicense"
              v-model="formData.operationalLicense"
            />
          </div>
          ...
          <div>
            ...
            <Input
              id="dateOperationalLicense"
              type="date"
              v-model="formData.dateOperationalLicense"
            />
          </div>
        </div>
      </div>
      ...
      <div class="bg-white p-6 rounded-lg border">
        ...
        <div class="space-y-4">
          <div>
            ...
            <div class="mt-2">
              <label
                class="flex items-center justify-center w-full h-32 border-2 border-dashed rounded-lg cursor-pointer hover:bg-gray-50"
              >
            ...
            <div v-if="formData.imageUrl.length > 0" class="mt-3 space-y-2">
              <div
                v-for="(url, index) in formData.imageUrl"
                :key="index"
      ...
      <div class="bg-white p-6 rounded-lg border">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            ...
            <Select
              v-model="formData.address.districtId"
              :disabled="!formData.address.provinceId"
              required
            >
              <SelectTrigger>
          ...
          <div>
            ...
            <Select
              v-model="formData.address.subDistrictId"
        ...
        <div class="space-y-4">
          ...
          <div class="flex items-center space-x-2">
            <input
              ...
              @change="
                (e) => (formData.isRecommended = e.target.checked ? 1 : 0)
              "
              class="h-4 w-4 rounded border-gray-300 text-primary focus:ring-2 focus:ring-primary"
            />
            <Label for="isRecommended" class="cursor-pointer"
              >Sekolah Rekomendasi</Label
            >
          </div>
        </div>
      </div>
      ...
      <div class="flex gap-3">
        <Button
          type="button"
          variant="outline"
          @click="navigateTo('/dashboard/school-lists')"
        >
          Batal
        </Button>
