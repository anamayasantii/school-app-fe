<template>
  <DashboardLayout>
    <div class="container mx-auto py-8 px-4">
      ...
      <h1 class="text-3xl font-bold mb-6">Review Rejected</h1>
      ...
      <div v-else-if="reviews.length === 0" class="text-center py-12">
        <p class="text-muted-foreground">Tidak ada review rejected</p>
      </div>
...
const fetchRejectedReviews = async () => {
  try {
    loading.value = true;
    const response = await axios.get("/reviews/rejected", {
      headers: {
    ...
    showToast("Error", "Gagal memuat review rejected", "destructive");
  } finally {
    loading.value = false;
  }
};
